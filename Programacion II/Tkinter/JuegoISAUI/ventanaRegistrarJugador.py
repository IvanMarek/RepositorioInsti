...
def ventana_Inicio():
    ...
    formulario_frame.pack(side="left", padx=(350, 0))
    ...
    instagram_label = ctk.CTkLabel(
        formulario_frame, text="Instagram", font=("Impact", 20)
    )
    ...
    jugadores_treeview = ttk.Treeview(
        frame2, columns=("Nombre", "Teléfono", "Instagram" "Puntaje", "Tiempo",), style="Treeview"
    )
    ...
    cursor.execute("""SELECT * FROM jugadores ORDER BY puntaje DESC;""")
    ...
    for resultado in jugadores:
        ...
        jugadores_treeview.insert(
            "",
            "end",
            values=[nombre, puntaje, tiempo, teléfono],
            tags=("fuente_personalizada",),
        )
